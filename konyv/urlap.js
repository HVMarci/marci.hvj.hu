//646. oldal következik a könyvben
...
$(document).ready(function() {
    ...
    function urlapotEllenoriz() {
        ...
        // Ellenőrizzük, hogy van-e valami a kötelezően megadandó mezőkben
        if ($('#nev').val() == "") {
            hibasMezok.push('nev');
        }
        if ($('#email').val() == "") {
        ...
        // nagyon alapvető e-mail ellenőrzés, csak @ jelet keres
        ...
        return hibasMezok;
    } // az urlapotEllenoriz fügvény vége
    ...
    function visszajelzestEltavolit() {
        ...
        $('.hibaszakasz').each(function() {
            $(this).removeClass("hibaVisszajelzes");
        });
    }
});